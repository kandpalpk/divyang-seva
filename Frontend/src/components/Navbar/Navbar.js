...
import Logo from "../../assets/divyang.png";
...
export const Navbar = ({ toggle, toggles }) => {
    return (
        <nav
            className='flex justify-between items-center h-16 bg-white text-black relative font-sans border-b-2 mt-1'
            role='navigation'
        >
            <Link to='/dashboard'>
                <div className='flex'>
                    <img src={Logo} alt='img' className='w-20 h-16 ml-5 mb-2' />
                </div>
            </Link>
